...
export const reportCards: ReportCardItem[] = [
  {
    ...
    desc: "أرصدة ومجاميع الحسابات حتى تاريخ محدد مع المستويات الشجرية والتوازن التلقائي",
    tag: "محاسبي",
    page: "trial-balance",
  },
  {
    title: "دفتر الأستاذ العام",
    desc: "كشف حركات الحساب التفصيلية مع احتساب الرصيد التراكمي اللحظي",
    tag: "محاسبي",
    page: "account-ledger",
  },
  {
    title: "قائمة الدخل والأرباح والخسائر",
    desc: "الإيرادات وتكلفة المبيعات (COGS) والمصروفات التشغيلية وصافي ربح الفترة",
    tag: "محاسبي",
    page: "profit-loss",
  },
  {
    title: "الميزانية العمومية والمركز المالي",
    desc: "الأصول والخصوم وحقوق الملكية والتحقق من المعادلة المحاسبية الذهبية",
    tag: "محاسبي",
    page: "balance-sheet",
  },
  {
    title: "الموقف الضريبي (VAT)",
    desc: "احتساب ضريبة المخرجات والمدخلات وصافي الالتزام المستحق لهيئة الزكاة والضريبة",
    tag: "ضريبي",
    page: "vat-position",
  },
  {
    title: "كشف حساب مورد / عميل",
    desc: "كشف الحساب المالي المعتمد لعميل أو مورد ومطابقته مع دفتر الأستاذ العام",
    tag: "مطابقة",
    page: "party-statement",
  },
  {
    title: "كارت أستاذ الصنف التاريخي",
    desc: "تتبع حركة الصنف التفصيلية، الرصيد الافتتاحي، والحركات التراكمية اللحظية",
    tag: "مخزني",
    page: "item-detail",
  },
  {
    title: "تقييم المخزون المالي والمطابقة",
    desc: "تقييم رأس المال المخزني بالتكلفة وسعر البيع والمطابقة اللحظية مع الأستاذ العام",
    tag: "رقابة",
